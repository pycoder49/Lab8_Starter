  ...
  window.addEventListener("load", () => {
    ...
    navigator.serviceWorker.register("./sw.js")
      .then((registration) => {
        ...
        console.log("Succesgull registration of service worker: ", registration);
      })
      .catch((error) => {
...
async function getRecipes() {
  ...
  const existing_recipies = localStorage.getItem("recipies");
  if(existing_recipies){ return JSON.parse(existing_recipies); }
  /**************************/
